...
parser.add_argument("--memory_mb", default=1, type=int)
parser.add_argument("--tocopy_mb", default=128, type=int) # should 
...
cpugen.addParams({
    ...
    "request_count": args.tocopy_mb * 1024 * 1024 / 8 # mb divided by bits per request. 
})
